    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="contacts">
                    <a href="#contacts">Contacts</a>
                                ...
                                <a href="#contacts-GETapi-contacts">Get all the authenticated user's contacts.</a>
                            </li>
                                                                        </ul>
                            </ul>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="contacts">Contacts</h1>
                                ...
                                <h2 id="contacts-GETapi-contacts">Get all the authenticated user&#039;s contacts.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/contacts/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/contacts/17"
);
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the contact. Example: <code>17</code></p>
            </div>
                    </form>
